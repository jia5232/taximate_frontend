...
import 'package:taximate/member/view/reset_password/password_reset_email_input_screen.dart';
import 'package:taximate/member/view/signup/school_search_screen.dart';
...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  void onContactPressed() async {
    ...
    try {
      ...
      getNoticeDialog(context, '기본 메일 앱을 사용할 수 없습니다. \n이메일로 연락주세요! 99jiasmin@gmail.com');
    }
  }
                  ...
                  children: [
                    GestureDetector(
                      onTap: (){
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => PasswordResetEmailInputScreen(),
                          ),
                        );
                      },
                      child: Text(
